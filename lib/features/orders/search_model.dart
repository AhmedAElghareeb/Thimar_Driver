class OrdersSearchData {
  late final List<OrderSearchModel> data;
  late final Links links;
  late final Meta meta;
  late final String message;
  late final String status;

  OrdersSearchData.fromJson(Map<String, dynamic> json){
    data = List.from(json['data'] ?? []).map((e)=>OrderSearchModel.fromJson(e)).toList();
...
class OrderSearchModel {
  ...
  OrderSearchModel.fromJson(Map<String, dynamic> json){
    id = json['id'] ?? 0;
    status = json['status'] ?? "";
    date = json['date'] ?? "";
    time = json['time'] ?? "";
